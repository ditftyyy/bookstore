...
<section class="hero-section">
    <div class="container">
        <div class="hero-content">
            <h1 class="hero-title">Menjelajahi Dunia Lewat Buku</h1>
            ...
            <a href="produk.php" class="btn-shop">Jelajahi Koleksi</a>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="welcome-content" data-aos="fade-right">
                    ...
                    <p class="welcome-text">Memasuki dunia di mana cerita hidup dan pengetahuan tak terbatas. Koleksi buku kami yang mencakup berbagai genre, budaya, dan era, memberikan pengalaman membaca yang tiada tanding.</p>
                    <a href="produk.php" class="btn-shop">Mulailah Perjalanan Anda</a>
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="quote-section">
    <div class="container">
        <div class="quote-content" data-aos="fade-up">
            ...
            <p class="quote-text">Buku adalah mimpi yang bisa kamu genggam di tanganmu</p>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <h3 class="feature-title">Koleksi Terpilih</h3>
                    <p class="feature-text">Buku-buku yang dipilih dengan cermat dari penulis dan penerbit ternama, memastikan pengalaman membaca berkualitas tinggi.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <p class="feature-text">Pengiriman cepat dan aman hingga ke pintu Anda dengan kemasan buku khusus.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <p class="feature-text">Setiap buku dijamin asli dan dilengkapi dengan penanda buku serta sampul pelindung dari kami.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <a href="detail_produk.php?id=<?php echo $value["id_produk"]; ?>" class="btn-view">View Details</a>
                        </div>
                    </div>
                </div>
            <?php endforeach ?>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="testimonial-card">
                    <p class="testimonial-text">"Kualitas buku luar biasa. Setiap pembelian selalu menjadi tambahan yang menyenangkan untuk saya."</p>
            ...
            <div class="col-md-4">
                <div class="testimonial-card">
                    <p class="testimonial-text">"Layanan pelanggan luar biasa. Mereka membantu saya menemukan edisi langka yang telah saya cari selama bertahun-tahun."</p>
            ...
            <div class="col-md-4">
                <div class="testimonial-card">
                    <p class="testimonial-text">"Perhatian terhadap detail dalam kemasan dan pengiriman buku sungguh luar biasa. Benar-benar pengalaman yang istimewa."</p>
